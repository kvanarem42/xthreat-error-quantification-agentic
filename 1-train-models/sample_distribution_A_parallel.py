...
for n_x, n_y in grid_sizes:
    ...
    for sample_size in sample_sizes:
        for i_bootstrap in range(rank, n_bootstraps, size):
            ...
            file_path = f'/scratch/kwvanarem/xthreat-research-v1/model-storage/run-18-03-2025/xt-N{sample_size}-n_x{n_x}-n_y{n_y}-i_bootstrap{i_bootstrap}-random_state{random_state}.pickle'
