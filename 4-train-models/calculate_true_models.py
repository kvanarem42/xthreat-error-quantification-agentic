...
# Load the data
data_path = '/home/kwvanarem/xthreat-research-v1/run-18-03-2025/xThreat_data_v2.parquet'
...
for n_x, n_y in grid_sizes: 
    ...
    file_path = f'/scratch/kwvanarem/xthreat-research-v1/model-storage/run-18-03-2025/true-models/xt-full-data-n_x{n_x}-n_y{n_y}.pickle'
